...
import requests
import logging
from coinmonitor.utils.db_postgres import WarehouseConnection
from coinmonitor.utils.config import get_warehouse_creds
...
def main() -> None:
    ...
    for d in data:
        d['updated_dt'] = get_utc_from_unix_time(d.get('updated'))
